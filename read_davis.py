...
class DavisReader:
    ...
    def augmentData(self):
        ...
        self.currentTrainImageSet = np.zeros((self.augMultiplier, CROP_HEIGHT, CROP_WIDTH, 
                                                image.shape[2]+1), 'uint8')
        self.currentTrainLabelSet = np.zeros((self.augMultiplier, CROP_HEIGHT, CROP_WIDTH, 
                                                NUM_CLASSES), 'uint8')
        idx = 0
        # rotate
